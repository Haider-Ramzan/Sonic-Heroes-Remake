...
Level3::Level3(int screenWidth)
    : Level("3", "Data/bg_space.png", screenWidth) {
    ...
    enemyArray[1] = (Motobug*)L1.createEnemy("CrabMeat", 6339.5 + 500, 767);
    enemyArray[2] = (BatBrain*)L1.createEnemy("BatBrain", 6339.5, 500);
    enemyArray[3] = (BeeBot*)L1.createEnemy("BeeBot", 1342, 300);
    enemyArray[4] = L1.createEnemy("MotoBug", 6339.5 + 3500 + 6000, 767);
    enemyArray[5] = L1.createEnemy("CrabMeat", 6339.5 + 3500 + 7500, 767);
    enemyArray[6] = L1.createEnemy("MotoBug", 6339.5 + 3500 + 7500, 767);
    enemyArray[7] = L1.createEnemy("BeeBot", 6339.5 + 3500 + 6000, 450);
    enemyArray[8] = (BatBrain*)L1.createEnemy("BatBrain", 1342 + 2500, 500);
...
void Level3::run(sf::RenderWindow& window, int& ringScore) {
    sf::Clock deltaClock;
    sf::Event ev;
    ...
    player->setHealth(10); ///remove later

    player->setAcceleration(0.5f);
    player->setDeacceleration(-0.5f);
    player->setGravity(0.5f);
    player->setTerminalVelocity(10);
...
bool Level3::isWinner() {
    if (player->getPosX() > 295 * 64) {
        return true;
    }
